		...
		<div class="d-flex flex-column">
			...
			<nav id="navbar" class="nav-menu navbar">
				<ul>
					...
					%>
					<a href="UpdatePassword" class="nav-link scrollto active"><i
						class='bx bx-key'></i></i><span>Update Password</span></a>
					</li>
					<li><a href="Logout" class="nav-link scrollto active"><i
							class='bx bx-exit'></i><span>Log out</span></a></li>
				</ul>
			</nav>
			<!-- .nav-menu -->
		</div>
